...
/* 40A04 80051AA4 3C048012 */  lui     $a0, %hi(gSaveContext)                ## $a0 = 80120000
/* 40A08 80051AA8 2484A5D0 */  addiu   $a0, $a0, %lo(gSaveContext)           ## $a0 = 8011A5D0
...
/* 40A18 80051AB8 3C018012 */  lui     $at, %hi(D_8011B9F8)                ## $at = 80120000
/* 40A1C 80051ABC AC20B9F8 */  sw      $zero, %lo(D_8011B9F8)($at)        ## 8011B9F8
/* 40A20 80051AC0 3C048012 */  lui     $a0, 0x8012                ## $a0 = 80120000
/* 40A24 80051AC4 3C018012 */  lui     $at, %hi(D_8011B9FC)                ## $at = 80120000
/* 40A28 80051AC8 2484A5D0 */  addiu   $a0, $a0, 0xA5D0           ## $a0 = 8011A5D0
/* 40A2C 80051ACC AC20B9FC */  sw      $zero, %lo(D_8011B9FC)($at)        ## 8011B9FC
...
/* 40A70 80051B10 3C038000 */  lui     $v1, %hi(gCurrentRegion)                ## $v1 = 80000000
/* 40A74 80051B14 8C636280 */  lw      $v1, %lo(gCurrentRegion)($v1)           ## 80006280
